...
public class MoveToFingerPathActivityC extends AppCompatActivity {
    ...
    private void openAlertDialog() {
        AlertDialog alertDialog = new AlertDialog.Builder(MoveToFingerPathActivityC.this, android.R.style.Theme_Holo_Light_NoActionBar_Fullscreen).create();
    ...
    private void openTutorialDialog() {
        ...
        dialogTutorial = new Dialog(MoveToFingerPathActivityC.this, android.R.style.Theme_DeviceDefault_Light_NoActionBar_Fullscreen);
